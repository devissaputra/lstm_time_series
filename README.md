...
This is a professor-readable AI Engineering project built around **real data**, an explicit processing mechanism, executable code, empirical evaluation, and a scientific-style technical report. It demonstrates **LSTM, time series, forecasting, temporal split** without hiding the data-processing choices inside an opaque notebook.

## Dataset
- **Dataset:** Mauna Loa atmospheric CO₂ dataset via statsmodels
- **Reference:** https://www.statsmodels.org/stable/datasets/generated/co2.html
